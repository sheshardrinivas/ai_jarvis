...
def main():
        ...
        string_print("The current directory is:"+current_dir,0.01,"")
        print("  ")
        string_print("add this path to your zshrc if your are following the optional steps. ---> "+current_dir+"/code/key.py",0.01,"")
        print("  ")
        ...
        if "y" in in1:
            ...
            string_print(string_0,0.01,colorama.Fore.WHITE)
        print("")
